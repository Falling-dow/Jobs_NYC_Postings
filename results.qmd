...
programming_summary <- nyc_jobs |> 
  mutate(
    Programming_Category = case_when(
      ...
      back_end_required & front_end_required ~ "Back-End & Front-End(HTML, CSS, JavaScript)"
    )
  ) |> 
